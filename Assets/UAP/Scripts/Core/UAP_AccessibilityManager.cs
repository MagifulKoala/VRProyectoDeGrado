...
public class UAP_AccessibilityManager : MonoBehaviour
{
	...
	public static void Say(string textToSay, UAP_AudioQueue.EAudioType audioType, bool canBeInterrupted = true, bool allowVoiceOver = true, UAP_AudioQueue.EInterrupt interrupts = UAP_AudioQueue.EInterrupt.Elements)
	{
		// IsEnabled calls Initialize()
		if (!IsEnabled())
			return;

		instance.m_AudioQueue.QueueAudio(textToSay, audioType, allowVoiceOver, null, interrupts, canBeInterrupted);
	}
